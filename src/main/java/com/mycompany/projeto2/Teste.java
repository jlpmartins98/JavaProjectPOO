                ...
                try{
                    ...
                    opcao = scan.nextInt();
                        ...
                        case 10:
                            ...
                            System.out.println("Candidatos para o prémio de carreira: " + festival.getPontuacoesPremioCarreira());
                            System.out.println();
                            System.out.println("O premio de carreira vai para: " + festival.getPontuacoesPremioCarreira().get(0));
                            System.out.println();
                            System.out.println("Candidatos para o prémio de melhor ator principal: " + festival.getPontuacoesPremioAtorPrincipal());
                            System.out.println();
                            System.out.println("O premio de melhor ator principal vai para: " + festival.getPontuacoesPremioAtorPrincipal().get(0));
                            System.out.println();
                            System.out.println("Candidatos para o prémio de melhor atriz prinicipal: " + festival.getPontuacoesPremioAtrizPrincipal());
                            System.out.println();
                            System.out.println("O premio de melhor atriz principal vai para: " + festival.getPontuacoesPremioAtrizPrincipal().get(0));
                            System.out.println();
                            System.out.println("Candidatos para o prémio de melhor ator secundário: " + festival.getPontuacoesPremioAtorSecundario());
                            System.out.println();
                            System.out.println("O premio de melhor ator secundario vai para: " + festival.getPontuacoesPremioAtorSecundario().get(0));
                            System.out.println();
                            System.out.println("Candidatos para o prémio de melhor atriz secundário: " + festival.getPontuacoesPremioAtrizSecundaria());
                            System.out.println();
                            System.out.println("O premio de melhor atriz secundaria vai para: " + festival.getPontuacoesPremioAtrizSecundaria().get(0));
                            System.out.println();
                            System.out.println("Candidatos para o prémio de melhor filme: " + festival.getPontuacoesPremioFilme());
                            System.out.println();
                        ...
                        System.out.println("Não contem esse elemento!");
                        scan.nextLine();
                    }
